...
/**
 * Project : php-troll library
 * Summary : A basic php library to talk with trollcoind 
 *
 * Original Source  : https://github.com/mkaz/php-doge
 * Adapted From : http://github.com/wpstudio/php-leaf
 * Source  : https://github.com/wpstudio/php-troll
 *
...
class Troll  {
    ...
    /**
     * Creates or Retrievs a Trollcoin address for a account name
     * An account is just a string used as key to identify account,
     * A Trollcoin address is return which can receive coins
     *
     * @param string $account some string used as key to account
     * @return string trollcoin address 
     */
    ...
    /**
     * Given a Trollcoin address returns the account name
     *
     * @param string $address trollcoin addresss
    ...
    /**
     * Get list of all accounts on in this trollcoind wallet
     *
    ...
    /**
     * Associate trollcoin address to account string
     *
     * @param string $address trollcoin address
     ...
     * Both accounts are local to this trollcoind instance
     *
    ...
    /**
     * Send coins to any Trollcoin Address
     *
     * @param string $account account sending coins from
     * @param string $to_address trollcoin address sending to
    ...
    /**
     * Pull Coin Mining Information from Trollcoin network
     * 
     ...
     */
     ...
     /**
      * Returns the transaction history of a specific trollcoin account
      * 
